...
class Solution(object):
    def detectCapitalUse(self, word):
        #istitle is really handy. I knew about upper and lower, found istitle
        #on stackoverflow
        return word.isupper() or word.islower() or word.istitle()

solution = Solution()
print(solution.detectCapitalUse("ThisIsNotCorrect"))
print(solution.detectCapitalUse("USA"))
print(solution.detectCapitalUse("Google"))
print(solution.detectCapitalUse("true"))
